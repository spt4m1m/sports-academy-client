            ...
            <footer className="text-gray-400 bg-black body-font">
                <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
                    <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
                        ...
                        <p className="mt-2 text-sm text-gray-500">Learn many sports with us</p>
                    </div>
                    <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
                        ...
                        <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                            ...
                            <nav className="list-none mb-10">
                                ...
                                <li>
                                    <Link to='/instructors' className="text-gray-400 hover:text-white">Instructors</Link>
                                </li>
                                <li>
                                    <Link to='/classes' className="text-gray-400 hover:text-white">Classes</Link>
                                </li>
                            </nav>
                        </div>
                        <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                ...
                <div className="bg-[#0a0f12] bg-opacity-75">
                    <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                        <p className="text-gray-400 text-sm text-center sm:text-left">© 2022 Sports Academy —
                            <a href='https://www.facebook.com/spt4m1m' rel="noopener noreferrer" className="text-primary ml-1" target="_blank">@SP Tamim</a>
                        </p>
                        <span className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
                            ...
                            <a target={blank} href='https://www.instagram.com/spt4m1m/' className="ml-3 text-primary">
